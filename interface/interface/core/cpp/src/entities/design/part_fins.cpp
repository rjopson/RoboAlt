...
Fins::Fins(const std::string& name, const std::string& comments, Material* material,
...
FinShapeType Fins::AssignedShapeType() const {
    return shape_->AssignedFinShapeType();
}
