...
struct SimulationStage {    
    Stage* stage = nullptr;    
    Motor* motor = nullptr;
    Drag* drag_with_stages_above = nullptr;
    Drag* drag_without_stages_above = nullptr;
    Drag* drag_drogue = nullptr;
    Drag* drag_main = nullptr;
    Drag* drag_current = nullptr;
    std::vector<SimulationUserCommand*> user_commands;
...
class Simulation : public Flight {
  ...
  private:    
    ...
    Drag* drag_current_;
    Phase phase_current_; //current phase of simulation    
}; 
#endif
