...
{
    const_str_digest_2a81da0a64105c559358acdbea78448b = UNSTREAM_STRING_ASCII( &constant_bin[ 2216508 ], 21, 0 );
    const_str_digest_04bcea50aaeac138039ba76563f5369c = UNSTREAM_STRING_ASCII( &constant_bin[ 2216529 ], 24, 0 );
    const_tuple_str_plain__inspect_tuple = PyTuple_New( 1 );
    const_str_plain__inspect = UNSTREAM_STRING_ASCII( &constant_bin[ 2216553 ], 8, 1 );
    PyTuple_SET_ITEM( const_tuple_str_plain__inspect_tuple, 0, const_str_plain__inspect ); Py_INCREF( const_str_plain__inspect );
    const_str_plain_NUITKA_PACKAGE_numpy_compat = UNSTREAM_STRING_ASCII( &constant_bin[ 2216561 ], 27, 1 );
    const_tuple_str_plain_py3k_tuple = PyTuple_New( 1 );
    const_str_plain_py3k = UNSTREAM_STRING_ASCII( &constant_bin[ 2216588 ], 4, 1 );
    ...
    const_str_digest_debbfb7d4cffd6e0773fb66f440d0d39 = UNSTREAM_STRING_ASCII( &constant_bin[ 2216592 ], 239, 0 );
