...
{
    const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2 = UNSTREAM_STRING_ASCII( &constant_bin[ 574425 ], 22, 0 );
    const_dict_f1ec38e40adf588151bc715eb5db92e5 = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 574447 ], 7362 );
    const_dict_2e033d8708b681122fdfcef1a8a4599e = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 581809 ], 13505 );
    const_dict_ad12f0538dbf4f95e013e30f96df136a = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 595314 ], 946 );
    const_str_digest_8a88317164860b547beff038de474299 = UNSTREAM_STRING_ASCII( &constant_bin[ 596260 ], 16, 0 );
    const_str_digest_4c41e0b73d97829c93c8a1dc02228f50 = UNSTREAM_STRING_ASCII( &constant_bin[ 574433 ], 13, 0 );
...
static PyCodeObject *codeobj_4cb0c9715aedd457d9f9204b119ffe24;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_8a88317164860b547beff038de474299 );
    codeobj_4cb0c9715aedd457d9f9204b119ffe24 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_36fd0a5f22ffa55f1b167216071d6ce2, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_4cb0c9715aedd457d9f9204b119ffe24;
    ...
    // Frame without reuse.
    frame_4cb0c9715aedd457d9f9204b119ffe24 = MAKE_MODULE_FRAME( codeobj_4cb0c9715aedd457d9f9204b119ffe24, module_idna$idnadata );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_4cb0c9715aedd457d9f9204b119ffe24 );
    assert( Py_REFCNT( frame_4cb0c9715aedd457d9f9204b119ffe24 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_4cb0c9715aedd457d9f9204b119ffe24 );
#endif
    popFrameStack();

    assertFrameObject( frame_4cb0c9715aedd457d9f9204b119ffe24 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_4cb0c9715aedd457d9f9204b119ffe24, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_4cb0c9715aedd457d9f9204b119ffe24->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_4cb0c9715aedd457d9f9204b119ffe24, exception_lineno );
    }
