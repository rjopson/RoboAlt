...
{
    const_str_digest_63c8d65d52fb58b39520700ee4ec5234 = UNSTREAM_STRING_ASCII( &constant_bin[ 320265 ], 31, 0 );
    const_str_digest_7718380faed4df7057283e0d1730db81 = UNSTREAM_STRING_ASCII( &constant_bin[ 320296 ], 12, 0 );
    const_str_digest_2d7789edc1b969a7b65442774639a050 = UNSTREAM_STRING_ASCII( &constant_bin[ 320308 ], 25, 0 );
    const_tuple_335b990c1cc0f8a22180626502e7512a_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 320333 ], 20485 );
    const_str_digest_3c0b6f52380870c9f2b2c99be827742d = UNSTREAM_STRING_ASCII( &constant_bin[ 320273 ], 22, 0 );
    const_str_plain_win1253_char_to_order_map = UNSTREAM_STRING_ASCII( &constant_bin[ 340818 ], 25, 1 );
    const_tuple_f1a24a289c33e4ce8cd3d7c4beee6f6a_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 340843 ], 1285 );
    const_tuple_314709394625831b834265dbf269a905_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 342128 ], 1285 );
    const_str_plain_Latin7_char_to_order_map = UNSTREAM_STRING_ASCII( &constant_bin[ 343413 ], 24, 1 );
    const_str_digest_7ca3e7632f1cccef85d1966320dcb68c = UNSTREAM_STRING_ASCII( &constant_bin[ 343437 ], 10, 0 );
    const_str_plain_GreekLangModel = UNSTREAM_STRING_ASCII( &constant_bin[ 343447 ], 14, 1 );
    const_float_0_982851 = UNSTREAM_FLOAT( &constant_bin[ 343461 ] );
...
static PyCodeObject *codeobj_4e160c30c2fcc9a4d660647e7753b385;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_2d7789edc1b969a7b65442774639a050 );
    codeobj_4e160c30c2fcc9a4d660647e7753b385 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_63c8d65d52fb58b39520700ee4ec5234, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_4e160c30c2fcc9a4d660647e7753b385;
    ...
    // Frame without reuse.
    frame_4e160c30c2fcc9a4d660647e7753b385 = MAKE_MODULE_FRAME( codeobj_4e160c30c2fcc9a4d660647e7753b385, module_chardet$langgreekmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_4e160c30c2fcc9a4d660647e7753b385 );
    assert( Py_REFCNT( frame_4e160c30c2fcc9a4d660647e7753b385 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_4e160c30c2fcc9a4d660647e7753b385 );
#endif
    popFrameStack();

    assertFrameObject( frame_4e160c30c2fcc9a4d660647e7753b385 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_4e160c30c2fcc9a4d660647e7753b385, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_4e160c30c2fcc9a4d660647e7753b385->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_4e160c30c2fcc9a4d660647e7753b385, exception_lineno );
    }
