...
{
    const_str_digest_9a8cb319aec60ead0975237a9305202f = UNSTREAM_STRING_ASCII( &constant_bin[ 387240 ], 33, 0 );
    const_tuple_f2c470729e0f10e437bc567e306ce1de_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 387273 ], 1285 );
    const_str_digest_d86ed6c0d4d851111712eea2af5c983a = UNSTREAM_STRING_ASCII( &constant_bin[ 388558 ], 27, 0 );
    const_str_plain_Turkish = UNSTREAM_STRING_ASCII( &constant_bin[ 388585 ], 7, 1 );
    const_str_plain_Latin5_TurkishCharToOrderMap = UNSTREAM_STRING_ASCII( &constant_bin[ 388592 ], 28, 1 );
    const_str_plain_TurkishLangModel = UNSTREAM_STRING_ASCII( &constant_bin[ 388620 ], 16, 1 );
    const_tuple_439339857850830237fd4916bd45a217_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 388636 ], 20485 );
    const_str_digest_505db4dfed8ce57136b6a88fb660a1e2 = UNSTREAM_STRING_ASCII( &constant_bin[ 387248 ], 24, 0 );
    const_float_0_97029 = UNSTREAM_FLOAT( &constant_bin[ 409121 ] );
    const_str_digest_e73b1cdb9cf9c90921f39f6162acd4c1 = UNSTREAM_STRING_ASCII( &constant_bin[ 409129 ], 10, 0 );
...
static PyCodeObject *codeobj_b41b3dfc013a76bf85c7719891093a73;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_d86ed6c0d4d851111712eea2af5c983a );
    codeobj_b41b3dfc013a76bf85c7719891093a73 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_9a8cb319aec60ead0975237a9305202f, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_b41b3dfc013a76bf85c7719891093a73;
    ...
    // Frame without reuse.
    frame_b41b3dfc013a76bf85c7719891093a73 = MAKE_MODULE_FRAME( codeobj_b41b3dfc013a76bf85c7719891093a73, module_chardet$langturkishmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b41b3dfc013a76bf85c7719891093a73 );
    assert( Py_REFCNT( frame_b41b3dfc013a76bf85c7719891093a73 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b41b3dfc013a76bf85c7719891093a73 );
#endif
    popFrameStack();

    assertFrameObject( frame_b41b3dfc013a76bf85c7719891093a73 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b41b3dfc013a76bf85c7719891093a73, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b41b3dfc013a76bf85c7719891093a73->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b41b3dfc013a76bf85c7719891093a73, exception_lineno );
    }
