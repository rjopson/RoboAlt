...
{
    const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0 = UNSTREAM_STRING_ASCII( &constant_bin[ 343469 ], 32, 0 );
    const_str_digest_7471331e815247d0957c902583d31a71 = UNSTREAM_STRING_ASCII( &constant_bin[ 343501 ], 26, 0 );
    const_tuple_4f19fa3634bb485716df7f8f5e81152b_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 343527 ], 1285 );
    const_float_0_984004 = UNSTREAM_FLOAT( &constant_bin[ 344812 ] );
    const_str_plain_HEBREW_LANG_MODEL = UNSTREAM_STRING_ASCII( &constant_bin[ 344820 ], 17, 1 );
    const_str_plain_WIN1255_CHAR_TO_ORDER_MAP = UNSTREAM_STRING_ASCII( &constant_bin[ 344837 ], 25, 1 );
    const_str_digest_e47a8de6b5727c65c2c3c97877c79198 = UNSTREAM_STRING_ASCII( &constant_bin[ 343477 ], 23, 0 );
    const_tuple_96aea69e7c6c4b34b6c5234187423b87_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 344862 ], 20485 );
...
static PyCodeObject *codeobj_bf9c74d93c0643d24015dd13ad51a0b8;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_7471331e815247d0957c902583d31a71 );
    codeobj_bf9c74d93c0643d24015dd13ad51a0b8 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_bf9c74d93c0643d24015dd13ad51a0b8;
    ...
    // Frame without reuse.
    frame_bf9c74d93c0643d24015dd13ad51a0b8 = MAKE_MODULE_FRAME( codeobj_bf9c74d93c0643d24015dd13ad51a0b8, module_chardet$langhebrewmodel );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_bf9c74d93c0643d24015dd13ad51a0b8 );
    assert( Py_REFCNT( frame_bf9c74d93c0643d24015dd13ad51a0b8 ) == 2 );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_bf9c74d93c0643d24015dd13ad51a0b8 );
#endif
    popFrameStack();

    assertFrameObject( frame_bf9c74d93c0643d24015dd13ad51a0b8 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_bf9c74d93c0643d24015dd13ad51a0b8, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_bf9c74d93c0643d24015dd13ad51a0b8->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_bf9c74d93c0643d24015dd13ad51a0b8, exception_lineno );
    }
