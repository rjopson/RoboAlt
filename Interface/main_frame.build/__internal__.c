...
extern PyObject *const_str_digest_730ed40a69058ef68727e67febbf1e63;
...
extern PyObject *const_str_digest_8a6c35ba3b096ed9004e3c14a471c221;
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_14_complex_call_helper_dict_unpacking_checks( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_16_complex_call_helper_pos_keywords_star_list_star_dict( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_12__unpack_set( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_14_complex_call_helper_dict_unpacking_checks( PyObject **python_pars )
{
    ...
    }
    {
        ...
        branch_yes_1:;
        {
            ...
            PyObject *tmp_right_name_1;
            PyObject *tmp_dircall_arg1_1;
            tmp_left_name_1 = const_str_digest_730ed40a69058ef68727e67febbf1e63;
            CHECK_OBJECT( par_called );
            tmp_dircall_arg1_1 = par_called;
            Py_INCREF( tmp_dircall_arg1_1 );
            ...
            {
                PyObject *dir_call_args[] = {tmp_dircall_arg1_1};
                tmp_right_name_1 = impl___internal__$$$function_2_get_callable_name_desc( dir_call_args );
            }
    ...
    }
    {
        ...
        PyObject *tmp_subscript_name_1;
        CHECK_OBJECT( tmp_args_item );
        tmp_subscribed_name_1 = tmp_args_item;
        CHECK_OBJECT( tmp_dict_key );
        ...
        CHECK_OBJECT( tmp_dict );
        tmp_dictset_dict = tmp_dict;
        CHECK_OBJECT( tmp_dict_key );
        tmp_dictset_key = tmp_dict_key;
        tmp_res = PyDict_SetItem( tmp_dictset_dict, tmp_dictset_key, tmp_dictset_value );
        Py_DECREF( tmp_dictset_value );
        if ( tmp_res != 0 )
        {
...

    {
        ...
        branch_yes_3:;
        {
            ...
            PyObject *tmp_source_name_1;
            PyObject *tmp_type_arg_2;
            tmp_left_name_3 = const_str_digest_9816e8d1552296af90d250823c964059;
            CHECK_OBJECT( par_called );
            tmp_dircall_arg1_3 = par_called;
            Py_INCREF( tmp_dircall_arg1_3 );
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_14_complex_call_helper_dict_unpacking_checks );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)tmp_dict );
    Py_DECREF( tmp_dict );
    tmp_dict = NULL;

    CHECK_OBJECT( (PyObject *)tmp_dicts_iter );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_13__unpack_dict( PyObject **python_pars )
{
...

    {
        ...
        branch_yes_1:;
        {
            ...
            PyObject *tmp_source_name_1;
            PyObject *tmp_type_arg_1;
            tmp_left_name_1 = const_str_digest_8a6c35ba3b096ed9004e3c14a471c221;
            CHECK_OBJECT( tmp_keys );
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_13__unpack_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)tmp_dict );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_15__unpack_list( PyObject **python_pars )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_15__unpack_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_16_complex_call_helper_pos_keywords_star_list_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_16_complex_call_helper_pos_keywords_star_list_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_17_complex_call_helper_pos_keywords_star_list( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_17_complex_call_helper_pos_keywords_star_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_12__unpack_set( PyObject **python_pars )
{
    ...
    {
        PyObject *tmp_set_name_1;
        PyObject *tmp_value_name_1;
        NUITKA_MAY_BE_UNUSED PyObject *tmp_setupdate_result_1;
        CHECK_OBJECT( tmp_set );
        tmp_set_name_1 = tmp_set;
        CHECK_OBJECT( tmp_keys );
        tmp_value_name_1 = tmp_keys;
        assert( PySet_Check( tmp_set_name_1 ) );
        tmp_res = _PySet_Update( tmp_set_name_1, tmp_value_name_1 );
        if ( tmp_res == -1 )
        {
            assert( ERROR_OCCURRED() );
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_12__unpack_set );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)tmp_set );
    Py_DECREF( tmp_set );
    tmp_set = NULL;
