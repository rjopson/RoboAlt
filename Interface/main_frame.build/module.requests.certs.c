...
{
    const_str_digest_fad30e997210978782478eaa6eec8851 = UNSTREAM_STRING_ASCII( &constant_bin[ 4016448 ], 23, 0 );
    const_str_digest_b5f91997557639393cd886902e945bcb = UNSTREAM_STRING( &constant_bin[ 4016471 ], 326, 0 );
    const_str_digest_6d124901291f8d751987282ee11fe1fc = UNSTREAM_STRING_ASCII( &constant_bin[ 4016456 ], 14, 0 );
    const_str_digest_3f8bf1b4e0b182ebb2871f66c15964a6 = UNSTREAM_STRING_ASCII( &constant_bin[ 4016797 ], 17, 0 );
...
static PyCodeObject *codeobj_93eec01ac8cfe0b6e64c0166d33cdbad;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_3f8bf1b4e0b182ebb2871f66c15964a6 );
    codeobj_93eec01ac8cfe0b6e64c0166d33cdbad = MAKE_CODEOBJ( module_filename_obj, const_str_digest_fad30e997210978782478eaa6eec8851, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_93eec01ac8cfe0b6e64c0166d33cdbad;
    ...
    // Frame without reuse.
    frame_93eec01ac8cfe0b6e64c0166d33cdbad = MAKE_MODULE_FRAME( codeobj_93eec01ac8cfe0b6e64c0166d33cdbad, module_requests$certs );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_93eec01ac8cfe0b6e64c0166d33cdbad );
    assert( Py_REFCNT( frame_93eec01ac8cfe0b6e64c0166d33cdbad ) == 2 );
    ...
    }
    {
        ...
        frame_93eec01ac8cfe0b6e64c0166d33cdbad->m_frame.f_lineno = 15;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_93eec01ac8cfe0b6e64c0166d33cdbad );
#endif
    popFrameStack();

    assertFrameObject( frame_93eec01ac8cfe0b6e64c0166d33cdbad );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_93eec01ac8cfe0b6e64c0166d33cdbad, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_93eec01ac8cfe0b6e64c0166d33cdbad->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_93eec01ac8cfe0b6e64c0166d33cdbad, exception_lineno );
    }
