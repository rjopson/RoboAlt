...
class MotorTestData():
    ...
    def __init__(self, name, diameter, length, delays, mass_propellant, mass_total, manufacturer, time_data, thrust_data, comment):
        self.name = name
    ...
    def named_attributes(self):
        return {"name":self.name, "diameter":self.diameter, "length":self.length,
                ...
                "manufacturer":self.manufacturer, "comment":self.comment}
