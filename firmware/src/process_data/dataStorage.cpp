 ...
 *
 */
void dataStorage::writeInt16(const int16_t& data) {
 ...
 *
 */
void dataStorage::writeInt32(const int32_t& data) {
 ...
 *
 */
int16_t dataStorage::readInt16() {

	int16_t buffer[2];
	buffer[0] = (int16_t)readByte();
	buffer[1] = (int16_t)readByte();

	return (int16_t)((	buffer[0] << 8) |
						buffer[1]);
}
 ...
 *
 */
int32_t dataStorage::readInt32() {

	int32_t buffer[4];
	buffer[0] = (int32_t)readByte();
	buffer[1] = (int32_t)readByte();
	buffer[2] = (int32_t)readByte();
	buffer[3] = (int32_t)readByte();
